...
env_var_get__99_v0 "AMBER_SCRIPT_AMBER_PATH"
__status=$?
amber_path_3="${ret_env_var_get99_v0}"
env_var_get__99_v0 "AMBER_SCRIPT_CACHE_PATH_INPUT"
__status=$?
cache_path_input_4="${ret_env_var_get99_v0}"
env_var_get__99_v0 "AMBER_SCRIPT_CONTENT"
__status=$?
script_content_5="${ret_env_var_get99_v0}"
env_var_get__99_v0 "AMBER_SCRIPT_HASH"
__status=$?
script_hash_6="${ret_env_var_get99_v0}"
# Calculate cache path
trim__11_v0 "${cache_path_input_4}"
ret_trim11_v0__13_28="${ret_trim11_v0}"
env_var_get__99_v0 "HOME"
__status=$?
ret_env_var_get99_v0__14_18="${ret_env_var_get99_v0}"
amber_cache_path_7="$(if [ "$([ "_${ret_trim11_v0__13_28}" != "_" ]; echo $?)" != 0 ]; then echo "${ret_env_var_get99_v0__14_18}/.cache/amber-script-action"; else echo "${cache_path_input_4}"; fi)"
dist_path_8="${amber_cache_path_7}/dist/${script_hash_6}.sh"
# Build the given script
file_exists__38_v0 "${dist_path_8}"
ret_file_exists38_v0__20_6="${ret_file_exists38_v0}"
if [ "${ret_file_exists38_v0__20_6}" != 0 ]; then
    echo "::debug::A compiled bash script found. Skip building."
else
    dir_create__43_v0 "${amber_cache_path_7}/tmp"
    __status=$?
    file_write__40_v0 "${amber_cache_path_7}/tmp/${script_hash_6}.ab" "${script_content_5}"
    __status=$?
